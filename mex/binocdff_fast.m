% binocdff_fast.m Help file for binocdff_fast MEX-file.
%  binocdff_fast.c - Fast evaluation of the Binomial cumulative distribution
%  function in single precision.
%
%  Y=binocdff_fast(X,N,P) returns the binomial cumulative distribution
...
%  
%  Y=binocdff_fast(X,N,P,1) returns the upper tail probability of the 
