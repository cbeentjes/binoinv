% binoinvf_fast.m Help file for binoinvf_fast MEX-file.
%  binoinvf_fast.c - Fast evaluation of the Binomial inverse cumulative 
%  distribution function in single precision.
%
%  X=binoinvf_fast(Y,N,P) returns the inverse of the binomial cdf with 
